                            ...
                            <div class="container">
                                ...
                                <div class="col-lg-12">
                                   ...
                                   <div class="row justify-content-center align-items-center minh-100 mb-2">
                                      ...
                                      <img class="symbol symbol-circle" style="width:50px" alt="Pic" src="<?php echo base_url(); ?>img/fichas/puja.png" onclick="ejecutar_apuesta_remate('<?php echo $row->id; ?>', '1')"/>
                                ...
                                <table style="background:#EED025; color: black;" width="100%">
                                  <thead class="font-size-xs">
                                    ...
                                    <thead class="text-negro">
                                        <tr>
                                            <th width="33%" class="text-center align-middle" style="border: black 1px solid; font-size: 12px;"><img src="<?php echo base_url(); ?>img/fichas/puja.png" class="rounded-circle" alt="Eniun" width="50"></th>
                                            <th width="33%" class="text-center align-middle" style="border: black 1px solid; font-size: 12px;"><img src="<?php echo base_url(); ?>img/fichas/correcto.png" class="rounded-circle" alt="Eniun" width="50"></th>
                                    ...
                                    <tbody class="text-negro">
                                        <tr>
                                            <th class="text-center align-middle" style="border: black 1px solid; font-size: 12px;">CON EL MARTILLO PUJAS POR TU EJEMPLAR</th>
                                            <th class="text-center align-middle" style="border: black 1px solid; font-size: 12px;">APUESTA REALIZADA</th>
                                            <th class="text-center align-middle" style="border: black 1px solid; font-size: 12px;">MONTO DE LA FICHAS ACUMULADAS</th>
...
setInterval(function(){ 
   ...
   url: "<?php echo site_url('carrera_caballo/cambios_sala') ?>",
               ...
               $('#boton_accion_apuesta_ganadores_'+x.co_sala_linea+'_'+1).html('<img class="symbol symbol-circle" style="width:50px" alt="Pic" src="'+base_url+'img/fichas/puja.png" onclick="ejecutar_apuesta_remate('+x.co_sala_linea+', '+1+')"/>')
                }
