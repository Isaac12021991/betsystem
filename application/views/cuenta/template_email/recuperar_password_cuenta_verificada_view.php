                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;"><b>Latin Club - Cuenta Verificada</b></h2>
                              <br>
                              
                          Estimado(a) <?php echo $nombre; ?>, su cuenta ha sido verificada con éxito.
<br />
<br>
...
<ul>
  <li> Nombre y apellido: <?php echo $nombre; ?> <?php echo $apellido; ?></li>
  <li> Cedula / Rif: <?php echo $cedula; ?></li>
  <li> Estado al que pertenece: <?php echo $nb_estado; ?></li>
