...
<body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4"  style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
  ...
  <tbody>
    <tr>
      <td valign="top" width="250">Latin Club</td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              <h2 style="font-size: 20px;"><b>Latin Club - Actualizacion de cuenta</b></h2>
                              <br>
                              
                          Saludos <?php echo $nombre; ?>, usted ha actualizado el correo electronico para el ingreso a nuestra  plataforma; de <b><?php echo $email_viejo; ?></b> a <b><?php echo $email; ?></b>, por seguridad para verificar su correo electronico haga click en el siguiente link.
<br />
<br>

<p align="center"> <a href="<?php echo $link; ?>"><?php echo $link; ?></a></p>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                              ...
                              Contactanos<br/>
                              info@subastahipica.net<br> <br>                     
                              </p><br>

<br>
<p style="font-size: 10px;" align="center">

Este e-mail fue enviado por: info@subastahipica.net – Latin Club - Venezuela.
Para asegurarse de recibir los mensajes agregue info@subastahipica.net  a su libreta de direcciones.</p>
