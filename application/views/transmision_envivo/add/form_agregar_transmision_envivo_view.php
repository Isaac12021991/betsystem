                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <a onclick="agregar_transmision_envivo()" class="btn btn-light-primary font-weight-bolder btn-sm mr-2">Guardar</a>
                                    ...
                                    <div class="card card-custom gutter-b">
                                         <div class="card-header">
                                          <div class="card-title">
                                           <h3 class="card-label">
                                            Crear
                                            <small>Crear transmision en vivo</small>
                                           </h3>
                                          </div>
                                         </div>
                                            ...
                                            <form class="form">
                                             <div class="card-body">
                                               ...
                                               <div class="col-9">
                                                <input type="text" name="nb_video" id="nb_video" class="form-control form-control-solid" placeholder="Nombre" value=""> 
                                               </div>
                                              </div>
                                   ...
                                   <?php foreach($sede->result() as $row){
                                    echo "<option value='".$row->nb_sede."'>".$row->nb_sede."</option>";
                                             ...
                                             <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                <textarea cols="4" id="tx_src" name="tx_src" class="form-control"  placeholder="SRC"></textarea>
                                               </div>
                                              </div>
                                               ...
                                               <div class="col-9">
                                                <textarea cols="4" id="tx_descripcion" name="tx_descripcion" class="form-control" maxlength="160" placeholder="Descripcion del video"></textarea>
                                               </div>
                                              </div>
...
<script type="text/javascript">
  ...
  function agregar_transmision_envivo()
   {
   ...
   if (nb_video == '') {
      ...
      if (tx_src == '') {
           ...
           return;
                            ...
                            $.ajax({
     method: "POST",
     data: {'nb_video':nb_video, 'tx_descripcion':tx_descripcion, 'tx_src':tx_src, 'nb_origen':nb_origen, 'co_sala':co_sala, 'nb_sede':nb_sede},
     url: "<?php echo site_url('transmision_envivo/guardar_nuevo_transmision_envivo') ?>",
                  }).done(function( data ) { 
