                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <a onclick="agregar_partner_configuracion()" class="btn btn-light-primary font-weight-bolder btn-sm mr-2">Guardar</a>
                                    ...
                                    echo "<option value='".$row->id."'>".$row->nb_sede.' Carrera:'.$row->nu_carrera."</option>";
                                           ...
                                           <div class="col-lg-6">
                                             ...
                                             <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                <textarea cols="4" id="tx_link" name="tx_link" class="form-control"></textarea>
                                               </div>
                                              </div>
                                             ...
                                             <div class="form-group row mb-2">
                                              ...
                                              <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                 <textarea class="form-control form-control-solid" maxlength="500" id="tx_descripcion" name="tx_descripcion" placeholder="Descripcion"></textarea>
                                               </div>
                                              </div>
...
<script type="text/javascript">
  ...
  function agregar_partner_configuracion()
   {
   ...
   if (nb_partner_configuracion == '') {
           ...
           return;
                            ...
                            $.ajax({
     method: "POST",
     data: {'nb_partner_configuracion':nb_partner_configuracion, 'tx_descripcion':tx_descripcion, 'tx_link':tx_link, 'nb_sede':nb_sede, 'co_sala':co_sala},
     url: "<?php echo site_url('partner_configuracion/guardar_nuevo_partner_configuracion') ?>",
                  }).done(function( data ) { 
