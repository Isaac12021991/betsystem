                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <a onclick="editar_sede()" class="btn btn-light-primary font-weight-bolder btn-sm mr-2">Guardar</a>
                            ...
                            <div class="container">
                                           ...
                                           <h3 class="card-label">
                                            ...
                                            <form class="form">
                                             <div class="card-body">
                                               ...
                                               <div class="col-9">
                                                <input type="text" name="nb_sede" id="nb_sede" class="form-control form-control-solid" placeholder="Nombre" value="<?php echo $info_sede->nb_sede; ?>"> 
                                               </div>
                                              </div>
                                              ...
                                              <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                 <textarea class="form-control form-control-solid" maxlength="160" id="tx_descripcion" name="tx_descripcion" placeholder="Descripcion"><?php echo $info_sede->tx_descripcion; ?></textarea>
                                               </div>
                                              </div>
                                ...
                                <div class="form-group row mb-2">
                                   ...
                                   <div class="col-9">
                                    ...
                                    <div class="image-input-wrapper" style="background-image: url('<?php echo $info_sede->nb_url_foto; ?>');"></div>
...
<script type="text/javascript">
    ...
    $('#in_webservice').val('<?php echo $info_sede->in_webservice; ?>');
