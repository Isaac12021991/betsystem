                    ...
                    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <a onclick="agregar_taquilla()" class="btn btn-light-primary font-weight-bolder btn-sm mr-2">Guardar</a>
                                    ...
                                    <div class="card card-custom gutter-b">
                                          ...
                                          <div class="card-title">
                                           <h3 class="card-label">
                                            ...
                                            <form class="form">
                                             <div class="card-body">
                                               ...
                                               <div class="col-9">
                                                <input type="text" name="nb_taquilla" id="nb_taquilla" class="form-control form-control-solid" placeholder="Nombre" value=""> 
                                               </div>
                                              </div>
                                           ...
                                           <div class="col-lg-6">
                                             ...
                                             <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                <textarea cols="4" id="tx_descripcion" name="tx_descripcion" class="form-control" maxlength="160"></textarea>
                                               </div>
                                              </div>
                                     ...
                                     <div class="col-lg-6">
                                             ...
                                             <div class="form-group row mb-2">
                                               ...
                                               <div class="col-9">
                                                <input type="number" name="ca_porcentaje" id="ca_porcentaje" class="form-control form-control-solid" placeholder="Porcentaje" value=""> 
                                               </div>
                                              </div>
  ...
  function agregar_taquilla()
   ...
   if (nb_taquilla == '') {
           ...
           return;
                            ...
                            $.ajax({
     method: "POST",
     data: {'nb_taquilla':nb_taquilla, 'tx_descripcion':tx_descripcion, 'co_usuario':co_usuario, 'ca_porcentaje':ca_porcentaje},
     url: "<?php echo site_url('taquilla/guardar_nuevo_taquilla') ?>",
                  }).done(function( data ) { 
